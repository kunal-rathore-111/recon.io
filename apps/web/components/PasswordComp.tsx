...
interface PasswordComponentDTO {
  placeholder?: string,
  label?: string,
...
export function PasswordComponent({ placeholder, label, shouldShowStrength = true, password, setPassword, showForgetPassword = false }: PasswordComponentDTO) {
  ...
  const checkStrength = (pass: string) => {
    const requirements = [
      ...
      { regex: /[$%^&#@]/, text: "At least special letter ($%^&#@)" },
    ];
